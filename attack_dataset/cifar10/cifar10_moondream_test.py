...
OUTPUT_CSV = Path(
    DEVICE_LOG_DIR / "moondream2_docci_instruct_cifar10_test_predictions.csv"
)

# 10 for quick testing.
# 1000 for a larger experiment.
# None for all 10,000 CIFAR-10 test images.
...
MODEL_NAME = "Moondream2-DoCCI-Instruct-CIFAR10"
...
def score_candidate_classes(
    ...
    """
    Score all ten CIFAR-10 labels using the same
...
print(
    "TESTING MOONDREAM2 DoCCI INSTRUCT ON CIFAR-10"
)
