"""
Load Only: YOLO26 Nano CIFAR-10 CPU Inference
=============================================

This script DOES NOT train.

It only:
1. Loads yolo26n_cifar10_cpu.pt
2. Downloads the CIFAR-10 test split
...
Run:
    python load_only_test_1000_yolo26n_cifar10_cpu.py
"""
...
MODEL_PATH = Path.cwd() / "yolo26n_cifar10_cpu.pt"

DATA_ROOT =  "../data"
OUTPUT_ROOT = Path.cwd() / "yolo26n_cifar10_cpu_test_results"
...
def main() -> dict[str, str | None]:
    if not MODEL_PATH.exists():
        raise FileNotFoundError(
            ...
            f"{MODEL_PATH}\n\n"
            "Place yolo26n_cifar10_cpu.pt in the same "
            "folder as this script."
        )

    print("=" * 80)
    print("LOAD-ONLY YOLO26 NANO CIFAR-10 CPU TEST")
    print("=" * 80)
    ...
    # Download/load official CIFAR-10 test split.
    ...
    if len(test_dataset) < NUM_TEST_SAMPLES:
        raise ValueError(
            f"CIFAR-10 test set contains only "
        ...
        telemetry_rows.append(
            {
                ...
                "collection_mode": (
                    "yolo26n_cifar10_cpu_load_only_test"
                ),
                ...
                "model_type": (
                    "YOLO26N_CIFAR10_CLASSIFICATION_CPU"
                ),
